...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="index.jsp">Trang chủ</a> <span class="mx-2 mb-0">/</span> <strong
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 mb-3 text-black">Thông tin liên lạc</h2>
                </div>
                ...
                <div class="col-md-7">
                    <form action="#" method="post">
                        <div class="p-3 p-lg-5 border">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="c_message" class="text-black">Nguyên nhân</label>
                ...
                <div class="col-md-5 ml-auto">
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">Tam sơn</span>
                        <p class="mb-0">Xóm tự, Tam sơn, Từ Sơn, Bắc Ninh</p>
