        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                    <div class="site-logo">
                        <a href="/test" class="js-logo-clone">Shoppers</a>
                    </div>
                </div>
    ...
    <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
            <ul class="site-menu js-clone-nav d-none d-md-block" style="padding: 0">
                <li class="${home_active}"><a href="/test">Home</a></li>
                <li class="${about_active}"><a href="../test/about.jsp">About</a></li>
                <li class="${shop_active}"><a href="shop">Shop</a></li>
                <li class="${contact_active}"><a href="../test/contact.jsp">Contact</a></li>
